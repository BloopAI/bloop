...
const UsagePopover = ({}: Props) => {
  ...
  return !hasCheckedQuota || isSubscribed ? null : (
    <div className="flex flex-col items-start gap-2.5 p-2.5 mx-auto mb-2 w-full max-w-[16.875rem] rounded-md border border-bg-border bg-bg-base shadow-high select-none">
