...
const Onboarding = ({ activeTab }: { activeTab: string }) => {
  ...
  const { isSelfServe, setEnvConfig, envConfig } = useContext(DeviceContext);
  ...
  return shouldShowWelcome ? (
    isSelfServe ? (
      <SelfServe activeTab={activeTab} />
    ) : (
      <Desktop activeTab={activeTab} closeOnboarding={closeOnboarding} />
    )
  ) : null;
};
