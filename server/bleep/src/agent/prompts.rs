...
pub fn system<'a>(paths: impl IntoIterator<Item = &'a str>) -> String {
    ...
    s.push_str("### FUNCTIONS ###\n\n[{\"name\":\"code\",\"description\":\"Search the contents of files in a codebase semantically. Results will not necessarily match search terms exactly, but should be related.\",\"parameters\":{\"type\":\"object\",\"properties\":{\"query\":{\"type\":\"string\",\"description\":\"The query with which to search. This should consist of keywords that might match something in the codebase, e.g. 'react functional components', 'contextmanager', 'bearer token'. It should NOT contain redundant words like 'usage' or 'example'.\"}},\"required\":[\"query\"]}},{\"name\":\"path\",\"description\":\"Search the pathnames in a codebase. Use when you want to find a specific file or directory. Results may not be exact matches, but will be similar by some edit-distance.\",\"parameters\":{\"type\":\"object\",\"properties\":{\"query\":{\"type\":\"string\",\"description\":\"The query with which to search. This should consist of keywords that might match a path, e.g. 'server/src'.\"}},\"required\":[\"query\"]}},{\"name\":\"none\",\"description\":\"Call this to answer the user. Call this only when you have enough information to answer the user's query.\",\"parameters\":{\"type\":\"object\",\"properties\":{\"paths\":{\"type\":\"array\",\"items\":{\"type\":\"integer\",\"description\":\"The indices of the paths to answer with respect to. Can be empty if the answer is not related to a specific path.\"}}},\"required\":[\"paths\"]}},{\"name\":\"proc\",\"description\":\"Read one or more files and extract the snippets of text that are relevant to the search terms.\",\"parameters\":{\"type\":\"object\",\"properties\":{\"query\":{\"type\":\"string\",\"description\":\"A search query consisting of keywords.\"},\"paths\":{\"type\":\"array\",\"items\":{\"type\":\"integer\",\"description\":\"The indices of the paths to search.\"}}},\"required\":[\"query\",\"paths\"]}}]\n");
